...
export default async function EstrattiContoPage() {
  ...
  const [
    ...
    admin.from('corsi').select('id, project_id, title, formatore_id, corso_completato, corso_completato_at, tariffa_oraria, notula_id').eq('corso_completato', true).not('formatore_id', 'is', null),
